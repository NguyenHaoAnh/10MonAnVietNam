...
training_set=train_datagen.flow_from_directory('D:\\\\Anh\\\\Python\\\\10MonAnVietNam\\\\train',
                                               target_size=(150,150),
                                               batch_size=32,
                                               class_mode ='categorical')
test_set=train_datagen.flow_from_directory('D:\\\\Anh\\\\Python\\\\10MonAnVietNam\\\\test',
                                               target_size=(150,150),
                                               batch_size=32,
                                               class_mode ='categorical')
